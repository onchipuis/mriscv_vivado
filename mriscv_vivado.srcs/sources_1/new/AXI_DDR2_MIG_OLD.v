...
//    -- delayed data
	...
	bus_sync_sf #(.impl(3), .sword(2)) sync_flags(.CLK1(mem_ui_clk), .CLK2(CLK), .RST(RST), 
	...
	bus_sync_sf #(.impl(3), .sword(2)) sync_flagso(.CLK1(CLK), .CLK2(mem_ui_clk), .RST(RST), 
