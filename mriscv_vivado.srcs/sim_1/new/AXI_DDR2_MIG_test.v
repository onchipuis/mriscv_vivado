...
// HELPER
    ...
    wire [1:0]  ddr2_dqs_n;
        ...
        integer PERIOD = 16200 ;
        integer PERIOD200 = 5000 ;
        integer i, error;
        ...
        always
        begin #(PERIOD200/2) CLK_200MHZ = ~CLK_200MHZ; end 
        ...
        initial begin
            ...
            for(i = 0; i < tries*4; i = i+4) begin
                #(PERIOD*8);
                // WRITTING TEST
                axi_awvalid = 1'b1;
				axi_awaddr = i|32'h81011000;//xorshift64_state[sword*2-1:sword];
                #PERIOD;
                ...
                // WRITTING TEST
                axi_arvalid = 1'b1;
				axi_araddr = i|32'h81011000;//xorshift64_state[sword*2-1:sword];
                #PERIOD;
